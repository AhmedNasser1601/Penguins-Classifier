...
trainpred, testpred = (train_data.dot(weight.transpose()) + bias), (test_data.dot(weight.transpose()) + bias)
yPredTrain, yPredTest = (np.where(trainpred > 0, 1, -1)), (np.where(testpred > 0, 1, -1))
